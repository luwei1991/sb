...
//                        .selectionMedia()// 是否传入已选图片 List<LocalMedia> list
                        ...
                        .forResult(Select_Check);//结果回调onActivityResult code
...
//                        .selectionMedia()// 是否传入已选图片 List<LocalMedia> list
                        ...
                        .recordVideoSecond(600)//视频秒数录制 默认60s int
                        .isDragFrame(false)// 是否可拖动裁剪框(固定)
                        .forResult(Select_Handle);//结果回调onActivityResult code
...
//                        .selectionMedia()// 是否传入已选图片 List<LocalMedia> list
    ...
    protected void convert(ViewHolder holder, TaskSample task) {
        ...
        holder.mRecyclerViewVideo.setAdapter(new VideoAndTextRecyclerViewAdapter(holder.itemView.getContext(), task.videoList, fragment));
