...
public class MediaHelper {
     ...
     * @param requstCode
     */
    public static void startGallery(Fragment fragment, int selectionMode, int requstCode) {
        int maxSelectNum = 1;
...
//                .compressSavePath(Constants.COMPRESS_IMAGE_PATH)//压缩图片保存地址
...
//                        .selectionMedia()// 是否传入已选图片 List<LocalMedia> list
     ...
     * 取选择视频
     */
    public static void startVideo(Fragment fragment, int requstCode) {
        PictureSelector.create(fragment)
