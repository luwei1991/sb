...
public class ListTipView extends View {
    ...
    // 存储每个Item的信息
    private List<ListTipItem> mItemList = new ArrayList<>();
    // 存储每个方块
    ...
    public ListTipView(Context context, ViewGroup rootView, int x, int y, List<ListTipItem> mItemList) {
        super(context);
        // 设置传入过来的x轴坐标
        this.x = x;
        // 设置传入过来的y轴坐标
    ...
    public void setTipItemList(final List<ListTipItem> list) {
        mItemList.clear();
        List<ListTipItem> items = list;
        for (ListTipItem item : items) {
    ...
    public static class Builder {
        ...
        private List<ListTipItem> mTipItemList = new ArrayList<>();
        ...
        public Builder addItem(ListTipItem tipItem) {
            mTipItemList.add(tipItem);
            return this;
        }

        public Builder addItems(List<ListTipItem> list) {
        ...
        public ListTipView create() {
            ListTipView flipShare = new ListTipView(mContext, mRootView, x, y, mTipItemList);
